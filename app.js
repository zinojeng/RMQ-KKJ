const trips = [
  { id:"T01", level:"fit", label:"首選", agency:"旅遊家旅行社", code:"FUK05260925A", name:"九州神話秘境 5 日", subtitle:"高千穗、南阿蘇鐵道、柳川、糸島、雙溫泉", price:38900, score:82.5, free:0, selfMeals:1, dutyFree:0, malls:1, factories:1, summary:"7/13 公開頁面已改為全程團體行程；沒有遊樂園，僅第 4 天晚餐自理，主要取捨是第 3 天長途拉車。", source:"https://b2b.travelerts.com.tw/EW/GO/GroupDetail.asp?prodCd=FUK05260925A", days:["台中→北九州","門司港→唐戶市場→湯布院→別府","高千穗峽→天岩戶神社→南阿蘇鐵道","柳川遊船→太宰府→福岡塔→LaLaport","糸島→一蘭之森→機場"] },
...
const tripInsights = {
  T01:{ verdict:"7/13 公開頁面已改為沒有自由活動、沒有遊樂園，且只有第 4 天晚餐自理；特色餐與雙溫泉訴求也完整。主要代價是第 3 天別府至高千穗、南阿蘇一線的長途移動。", amusement:"沒有遊樂園或動物園。高千穗、柳川、糸島與南阿蘇鐵道都屬自然、文化或交通體驗。", freeDetail:"0 日。7/13 公開版本的第 5 天直接由飯店前往糸島、一蘭之森與機場。", shoppingDetail:"1 個大型商場與 1 個商品型見學：第 4 天 LaLaport、第 5 天一蘭之森。", mealDetail:"共 1 餐自理：第 4 天晚餐。第 5 天午餐已列一蘭拉麵料理。", theme:"高千穗神話自然、南阿蘇鐵道、柳川遊船與糸島海岸，景點類型平均。", pace:"移動量高。路線跨北九州、大分／別府、高千穗、福岡與糸島。", bestFor:"重視特色餐與雙溫泉、不要自由活動，也能接受第 3 天長車程的人。", warning:"第 3 天是明顯長車日；飯店仍以多個候選或同級呈現，實際起終點可能改變估算。"},
  T02:{ verdict:"自由活動與自理餐控制得和旅遊家一樣好，購物也只有 2 站。最大差異是 Safari Land：它不是機械式遊樂園，但仍是以動物觀賞與餵食為核心的園區；另外成人價比旅遊家高 5,000 元。", amusement:"沒有機械式主題樂園，但第 3 天安排 Safari Land 自然動物園。若你的『不要遊樂園』也包含不想去動物園，這團就應排除。", freeDetail:"0 日。全程團體行程，沒有半日或整日自由活動。", shoppingDetail:"共 2 個明確商業停留：第 4 天免稅店與 LaLaport，同樣集中在一天。", mealDetail:"共 1 餐自理：第 2 天唐戶市場午餐。這種自理餐可自行挑海鮮，但也代表費用與座位要自己處理。", theme:"山口自然與文化景觀最突出，包括秋芳洞、琉璃光寺、元乃隅神社與角島大橋。", pace:"相對移動量中等。主要集中在北九州、山口與福岡，比跨宮崎、熊本的路線單純。", bestFor:"能接受自然動物園，而且特別想看山口海岸、洞窟與神社景觀的人。", warning:"四個首選中價格最高；Safari 是否符合個人定義，是下訂前最需要先確認的問題。"},
...
const comfortProfiles = {
  T01:{drive:3,meal:5,stay:4,onsen:2,pace:3,clarity:3,driveText:"團體巴士五日推估約 12 小時 40 分～15 小時；第 3 天約 4 小時 15 分～4 小時 50 分，是最明顯長車日。",mealLevelText:"特色餐最強之一：河豚、螃蟹吃到飽、水炊雞鍋與一蘭；僅第 4 天晚餐自理。",lodgingText:"文案主打雙溫泉，候選飯店包含別府與南關／阿蘇一帶；實際飯店與房型未鎖定。"},
  T02:{drive:2,meal:4,stay:4,onsen:1,pace:2,clarity:2,driveText:"團體巴士五日推估約 9 小時 45 分～12 小時 15 分，四團最少；第 4 天約 4 小時～4 小時 40 分最長。",mealLevelText:"河豚御膳、蕎麥御膳與飯店料理，自理餐在唐戶市場，可自行挑海鮮。",lodgingText:"包含湯田溫泉住宿；其餘飯店仍以候選或同級為準。"},
  T03:{drive:3,meal:4,stay:3,onsen:1,pace:3,clarity:3,driveText:"團體巴士五日推估約 12 小時 5 分～15 小時 20 分，另有觀光列車、渡輪與賞豚船時間；第 4、5 天連續偏長。",mealLevelText:"多數正餐包含，另有燒肉吃到飽；只有回程日午餐自理。",lodgingText:"有溫泉區住宿安排，但確切飯店、房型與館內設施需再次確認。"},
  T04:{drive:3,meal:4,stay:3,onsen:1,pace:3,clarity:3,driveText:"團體巴士五日推估約 16 小時 50 分～19 小時 40 分，四團最高；第 3 天約 6 小時～6 小時 45 分。",mealLevelText:"多數正餐包含，另有燒肉吃到飽；只有回程日午餐自理。",lodgingText:"行程含地方飯店與溫泉可能性，但品牌、房型與溫泉設備應以最終名單確認。"},
...
const driveEstimates = {
  T01:{total:"12 小時 40 分～15 小時",longest:"第 3 天",days:[
    {day:1,route:"北九州機場→小倉／北九州飯店",nav:"29 分・23 km",bus:"35～50 分",note:"晚班抵達，主要是機場接駁。"},
    {day:2,route:"北九州→門司港→唐戶→湯布院→別府",nav:"2 小時 39 分・162 km",bus:"3 小時～3 小時 30 分",note:"下午由下關跨到大分，單段偏長。"},
    {day:3,route:"別府→高千穗→天岩戶→南阿蘇→南關",nav:"3 小時 43 分・220 km",bus:"4 小時 15 分～4 小時 50 分",note:"山區道路多，是本團最累的長車日。"},
    {day:4,route:"南關→柳川→太宰府→福岡市區",nav:"1 小時 58 分・114 km",bus:"2 小時 20 分～2 小時 50 分",note:"景點密集，但移動範圍相對集中。"},
    {day:5,route:"福岡→糸島→一蘭之森→北九州機場",nav:"2 小時 7 分・147 km",bus:"2 小時 30 分～3 小時",note:"回程日仍要由福岡西側折返北九州機場。"}
  ]},
  T02:{total:"9 小時 45 分～12 小時 15 分",longest:"第 4 天",days:[
    {day:1,route:"北九州機場→小倉／北九州飯店",nav:"29 分・23 km",bus:"35～50 分",note:"晚班抵達，主要是機場接駁。"},
    {day:2,route:"北九州→門司港→赤間神宮→唐戶→湯田溫泉",nav:"1 小時 35 分・94 km",bus:"1 小時 50 分～2 小時 20 分",note:"景點順路向東，移動較好理解。"},
    {day:3,route:"湯田→琉璃光寺→秋芳洞→Safari→萩一帶",nav:"1 小時 20 分・75 km",bus:"1 小時 35 分～2 小時 10 分",note:"景點多但彼此距離近，是較短的一天。"},
    {day:4,route:"萩→元乃隅→角島→福岡市區",nav:"3 小時 28 分・229 km",bus:"4 小時～4 小時 40 分",note:"由山口西北角一路回福岡，是唯一明顯長車日。"},
    {day:5,route:"福岡→竈門神社→太宰府→北九州機場",nav:"1 小時 28 分・89 km",bus:"1 小時 45 分～2 小時 15 分",note:"回程動線相對直接。"}
  ]},
  T03:{total:"12 小時 5 分～15 小時 20 分",longest:"第 4、5 天",days:[
    {day:1,route:"北九州機場→小倉／北九州飯店",nav:"29 分・23 km",bus:"35～50 分",note:"晚班抵達，主要是機場接駁。"},
    {day:2,route:"北九州→虹之松原→武雄→嬉野",nav:"2 小時 46 分・174 km",bus:"3 小時 15 分～3 小時 50 分",note:"由北九州直接跨到佐賀西部。"},
    {day:3,route:"嬉野→島原鐵道／渡輪→天草賞豚→L'isola",nav:"無法單純比較",bus:"約 1 小時 40 分～2 小時 30 分",note:"另有列車、渡輪與賞豚船；交通體驗時間不等於巴士車程。"},
    {day:4,route:"天草→高千穗→天岩戶→熊本",nav:"3 小時 4 分・215 km",bus:"3 小時 35 分～4 小時 10 分",note:"天草到高千穗跨距大，山區路段使誤差較高。"},
    {day:5,route:"熊本→太宰府→福岡市區→北九州機場",nav:"2 小時 53 分・188 km",bus:"3 小時 20 分～4 小時",note:"回程日還含免稅店與 LaLaport，坐車與停留都偏緊。"}
  ]},
  T04:{total:"16 小時 50 分～19 小時 40 分",longest:"第 3 天",days:[
    {day:1,route:"北九州機場→小倉／北九州飯店",nav:"29 分・23 km",bus:"35～50 分",note:"晚班抵達，主要是機場接駁。"},
    {day:2,route:"北九州→由布院→別府纜車→大分／別府",nav:"1 小時 54 分・114 km",bus:"2 小時 15 分～2 小時 45 分",note:"跨到大分，但動線大致順向。"},
    {day:3,route:"大分／別府→日向岬→日南→鵜戶→宮崎",nav:"5 小時 22 分・311 km",bus:"6 小時～6 小時 45 分",note:"四團最長的單日，且包含較多一般道路。"},
    {day:4,route:"宮崎→霧島黑醋→人吉→酒造→熊本港",nav:"4 小時 2 分・251 km",bus:"4 小時 40 分～5 小時 20 分",note:"連續第二個長車日，還穿插兩個商品型見學。"},
    {day:5,route:"熊本→太宰府→福岡市區→北九州機場",nav:"2 小時 53 分・188 km",bus:"3 小時 20 分～4 小時",note:"回程日前往福岡再折返北九州機場。"}
  ]}
};
...
const criterionMeta = {
  ...
  driveText:{title:"拉車判讀",level:"路線推估",method:"先依旅行社 2026/07/13 公開的景點順序，以一般道路導航計算代表性起終點與里程，再加入大型巴士速度、上下車、休息站及市區壅塞緩衝。飯店多為『或同級』，所以區間不是旅行社保證，也不含景點停留、用餐、列車、渡輪或船程。"},
...
const bookingMeta = {
  drive:{title:"每日實際車程",intro:"下列為依公開景點順序推估的團體巴士區間，可先看五日總量與最長車日；確切時間仍受飯店、交通與休息站安排影響。",questions:["每天預計幾點離開飯店、幾點回飯店？","單段最長車程約幾小時？在哪一天？","途中是否固定安排休息站？長者可否優先安排靠前座位？"]},
...
function bookingComparison(trip,key) {
  ...
  if (key === "drive") { const estimate=driveEstimates[trip.id]; return {known:profile.driveText,missing:"仍需確認確切飯店、每日出發／回飯店時間、單段最長車程及休息站安排。",level:estimate ? "道路區間推估" : "相對推估"}; }
...
function driveEstimateMarkup(trip) {
  const estimate = driveEstimates[trip.id];
  if (!estimate) return `<ul class="evidence-list">${criterionFacts(trip,"driveText").map(fact=>`<li>${fact}</li>`).join("")}</ul><p class="drive-unavailable">此行程的公開住宿與逐日路線不足，暫不製造每日精確數字。</p>`;
  return `<div class="drive-summary"><div><span>五日巴士推估</span><strong>${estimate.total}</strong></div><div><span>最長車日</span><strong>${estimate.longest}</strong></div></div><div class="drive-table-shell"><table class="drive-estimate-table"><thead><tr><th>日</th><th>主要移動</th><th>道路導航基準</th><th>團體巴士合理區間</th><th>差異重點</th></tr></thead><tbody>${estimate.days.map(item=>`<tr><th>D${item.day}</th><td>${item.route}</td><td class="number-cell">${item.nav}</td><td class="bus-range">${item.bus}</td><td>${item.note}</td></tr>`).join("")}</tbody></table></div><div class="drive-legend"><span><b>道路導航</b>一般小客車路線基準</span><span><b>巴士區間</b>加計團體車況與停靠緩衝</span></div>`;
}
...
function openCriterionDialog(tripId,key) {
  ...
  document.querySelector("#criterion-dialog-title").textContent = meta.title;
  const evidence = key === "driveText" ? driveEstimateMarkup(trip) : `<ul class="evidence-list">${facts.map(fact=>`<li>${fact}</li>`).join("")}</ul>`;
  document.querySelector("#criterion-dialog-body").innerHTML = `<div class="evidence-level"><span>${meta.level}</span><b>${trip.code}</b></div><section><h3>目前判讀</h3><p class="dialog-judgement">${compareValue(trip,key)}</p></section><section><h3>實際內容與判讀依據</h3>${evidence}</section><section><h3>判讀方式與限制</h3><p>${meta.method}</p></section><a class="primary-link dialog-source" href="${trip.source}" target="_blank" rel="noreferrer">查看旅行社原始頁面<i data-lucide="external-link"></i></a>`;
  if (typeof dialog.showModal === "function") dialog.showModal(); else dialog.setAttribute("open","");
  if (window.lucide) window.lucide.createIcons();
}
