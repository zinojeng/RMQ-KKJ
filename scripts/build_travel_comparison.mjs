...
const trips = [
  ["T01", "普通", "旅遊家旅行社", "FUK05260925A", "九州神話秘境5日：高千穗、南阿蘇鐵道、柳川、糸島、雙溫泉", 35900, 25, 0, 0.5, 1, 1, 1, 0, "第5天公開頁面載有福岡半日自由活動；第5天午餐說明與餐表互相矛盾，報名前需書面確認。", "https://b2b.travelerts.com.tw/EW/GO/GroupDetail.asp?prodCd=FUK05260925A", "特色餐與價格有優勢，但不再視為完全符合"],
...
const daily = [
  ["T01",1,"台中→北九州","家中","家中","機上餐",""],["T01",2,"門司港→唐戶市場→湯布院→別府","飯店","河豚料理","飯店自助餐",""],["T01",3,"高千穗峽→天岩戶神社→南阿蘇鐵道","飯店","鄉土料理","螃蟹吃到飽",""],["T01",4,"柳川遊船→太宰府→福岡塔→免稅店→LaLaport","飯店","水炊雞肉鍋","自理","購物2站"],["T01",5,"福岡半日自由活動→糸島→一蘭之森→機場","飯店","頁面說明矛盾，需確認","機上餐","半日自由；午餐需確認"],
...
summary.getRange("A13:H13").values=[["快速判斷","華府Safari CIKKJ260925C","比旅遊家高8,000","動物園非機械遊樂園","豪斯登堡／FIT自由行","CI7380／CI7381","2026-07-13","公開可檢索範圍"]];
summary.getRange("A15:H17").values=[["為什麼首選","華府Safari團沒有自由活動、只有1餐自理，購物集中同一天；若連自然動物園也不要，改選山富鐵道或宮崎團。",null,null,null,null,null,null],["重要修正","旅遊家第5天公開頁面載有福岡半日自由活動，且午餐說明與餐表矛盾，因此降為普通並建議書面確認。",null,null,null,null,null,null],["未列入排名","雄獅可找到9/04同系列商品，但未找到可核實的9/25專屬團號與售價，因此不混入已確認9/25清單。",null,null,null,null,null,null]];
